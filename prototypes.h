...
int command_p(char line[], Stop **stops,Connection *connections, Route *routes, int *stop_num, int route_num);
...
int command_c(char line[], Route **routes,  Connection *connections, int *route_num);
int create_connection(char **arguments, Route **routes, Connection **connections, int route_index, int connection_num, int size_1, int size_2);
void add_route_information(char **arguments, Route **routes, int i, int connection_num, int size_1, int size_2);
void change_route_information(char **args, Route **routes, Connection **connections, int i, int add_end, int connection_num, int size);
int command_l(char line[], Route **routes, Stop *stops, Connection **connections, int *connection_num, int route_num, int stop_num);
