...
int handle_command(char line[], char command, Stop stops[], Route routes[], Connection connections[], int *route_num, int *stop_num, int *connection_num);
...
void create_connection(char **arguments, Route routes[], Connection connections[], int i, int connection_num);
...
int is_valid_connection(char **arguments, Route routes[], Stop stops[], int stop_num, int route_num);
